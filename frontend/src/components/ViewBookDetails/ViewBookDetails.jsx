...
const ViewBookDetails = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      const response = await axios.get(
        `https://the-book-spot-by-ravi.onrender.com/api/v1/get-book-by-id/${id}`
      );
  ...
  const handleAddToCart = async () => {
    const response = await axios.put(
      "https://the-book-spot-by-ravi.onrender.com/api/v1/addToCart",
      {},
      { headers }
    );
  ...
  const handleFavourite = async () => {
    const response = await axios.put(
      "https://the-book-spot-by-ravi.onrender.com/api/v1/add-book-to-favourite",
      {},
      { headers }
    );
    alert(response.data.message);
  ...
  const Delete = async () => {
    try {
      const response = await axios.delete(
        "https://the-book-spot-by-ravi.onrender.com/api/v1/delete-book",
        { headers }
      );
      alert(response.data.message);
      navigate("/all-books");
  ...
  const updateBook = async () => {
    try {
      const response = await axios.put(
        "https://the-book-spot-by-ravi.onrender.com/api/update-book",
        {},
        {
          headers,
        }
