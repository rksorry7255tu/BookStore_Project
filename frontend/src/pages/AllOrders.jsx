...
const AllOrders = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      const response = await axios.get(
        "https://the-book-spot-by-ravi.onrender.com/api/v1/get-all-orders",
        { headers }
      );
  ...
  const submitChanges = async (index) => {
    ...
    const response = await axios.put(
      `https://the-book-spot-by-ravi.onrender.com/api/v1/update-status/${id}`,
      Values,
      { headers }
    );
